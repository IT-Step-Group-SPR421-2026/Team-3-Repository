...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop_mvc_pv421.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop_mvc_pv421.Data.Entities.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop_mvc_pv421.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Shop_mvc_pv421.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Shop_mvc_pv421.Data.Entities.Order", b =>
                {
                    b.HasOne("Shop_mvc_pv421.Data.Entities.User", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shop_mvc_pv421.Data.Entities.OrderDetails", b =>
                {
                    b.HasOne("Shop_mvc_pv421.Data.Entities.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shop_mvc_pv421.Data.Entities.Product", "Product")
                        .WithMany("Orders")
